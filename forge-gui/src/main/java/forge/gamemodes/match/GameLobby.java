...
public abstract class GameLobby implements IHasGameType {
    ...
    public Runnable startGame() {
        ...
        for (final LobbySlot slot : activeSlots) {
            ...
            if (hasVariant(GameType.Commander) || hasVariant(GameType.DuelCommander) || hasVariant(GameType.Oathbreaker) || hasVariant(GameType.TinyLeaders) || hasVariant(GameType.Brawl)) {
        ...
        if (!variantTypes.isEmpty()) {
            ...
            isCommanderMatch = isBrawlMatch || isTinyLeadersMatch || isOathbreakerMatch || variantTypes.contains(GameType.DuelCommander) || variantTypes.contains(GameType.Commander);
            if (!isCommanderMatch) {
